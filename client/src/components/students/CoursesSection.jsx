...
const CoursesSection = () => {
  ...
  return (
    ...
    <div className='grid  grid-cols-[repeat(auto-fit,minmax(240px,1fr))] sm:grid-cols-2 gap-3 md:grid-cols-3 md:gap-4 lg:grid-cols-4 lg:gap-10 my-16 min-w-0 px-4 md:px-0'>
